...
<section class="bg-white dark:bg-gray-900">
  <div class="py-8 px-4 mx-auto max-w-screen-xl text-center sm:py-16 lg:px-6">
      <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">What Drives Us</h2>
      ...
      <div class="mt-8 lg:mt-12 space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Respect Nature</h3>
              <p class="mb-4 text-gray-500 dark:text-gray-400">Maximise recycling, avoid pollution, minimise water use and focus on energy efficiency.</p>
          ...
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Fair & Ethical</h3>
              <p class="mb-4 text-gray-500 dark:text-gray-400">We treat everyone we work with ethically. It's really important for us that everyone we work with gets a fair go!</p>
              <a href="#" class="inline-flex items-center text-sm font-medium text-primary-600 hover:text-primary-700 dark:text-primary-500 dark:hover:text-primary-400">
          ...
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Buy Less</h3>
              <p class="mb-4 text-gray-500 dark:text-gray-400">We honestly want everyone to actually buy less shite and use what we buy longer.</p>
              <a href="#" class="inline-flex items-center text-sm font-medium text-primary-600 hover:text-primary-700 dark:text-primary-500 dark:hover:text-primary-400">
...
<section class="bg-white dark:bg-gray-900">
  <div class="grid gap-8 py-8 px-4 mx-auto max-w-screen-xl sm:gap-16 lg:gap-20 md:grid-cols-2 lg:py-16 md:px-6">
      <div class="text-gray-500 sm:text-lg dark:text-gray-400 mb-8">
          <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 md:text-4xl dark:text-white">Our customers make us great</h2>
          <p class="font-light lg:text-xl">Here at flowbite we focus on markets where technology, innovation, and capital can unlock long-term value.</p>
      </div>
      <div class="grid grid-cols-2 gap-8 text-gray-500 sm:gap-12 sm:grid-cols-3 dark:text-gray-400">
          ...
          <a href="#" class="flex justify-center items-center">
              <svg class="h-10 hover:text-gray-900 dark:hover:text-white" viewBox="0 0 41 50" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  <path d="M39.6522 17.1487C39.3672 17.3698 34.3359 20.2049 34.3359 26.5087C34.3359 33.8002 40.7381 36.3798 40.9297 36.4436C40.9002 36.6009 39.9126 39.9764 37.5542 43.4158C35.4512 46.4424 33.255 49.4642 29.9138 49.4642C26.5727 49.4642 25.7129 47.5234 21.8559 47.5234C18.0971 47.5234 16.7607 49.528 13.7045 49.528C10.6484 49.528 8.51598 46.7274 6.06419 43.288C3.22425 39.2492 0.929688 32.9748 0.929688 27.0197C0.929688 17.4681 7.14023 12.4024 13.2525 12.4024C16.5003 12.4024 19.2075 14.5348 21.2466 14.5348C23.1874 14.5348 26.2141 12.2746 29.9089 12.2746C31.3092 12.2746 36.3406 12.4024 39.6522 17.1487ZM28.1548 8.23089C29.6829 6.41784 30.7639 3.90218 30.7639 1.38652C30.7639 1.03767 30.7344 0.683903 30.6705 0.398926C28.1843 0.49228 25.2265 2.05474 23.4429 4.12328C22.0426 5.71523 20.7356 8.23089 20.7356 10.7809C20.7356 11.1642 20.7995 11.5474 20.829 11.6703C20.9862 11.6998 21.2417 11.7341 21.4972 11.7341C23.7279 11.7341 26.5334 10.2405 28.1548 8.23089Z" fill="currentColor"/>
              </svg>                                                                                    
          </a>
          <a href="#" class="flex justify-center items-center">
          ...
          <a href="#" class="flex justify-center items-center">
              <svg class="h-8 hover:text-gray-900 dark:hover:text-white" viewBox="0 0 123 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M39.1055 24.8372L40.6293 21.298C42.2761 22.5269 44.4635 23.1659 46.6264 23.1659C48.224 23.1659 49.2317 22.5514 49.2317 21.6175C49.2071 19.0122 39.6708 21.0522 39.597 14.5143C39.5725 11.1963 42.5218 8.64014 46.7002 8.64014C49.1826 8.64014 51.665 9.2546 53.4346 10.6556L52.0091 14.2686C50.3869 13.2363 48.3715 12.4989 46.4544 12.4989C45.1517 12.4989 44.2915 13.1134 44.2915 13.8999C44.3161 16.456 53.9262 15.0551 54.0245 21.298C54.0245 24.6898 51.1488 27.0739 47.0197 27.0739C43.9965 27.0739 41.2192 26.3611 39.1055 24.8372Z" fill="currentColor"/>
                  <path d="M97.5979 20.0199C96.836 21.3471 95.4105 22.2565 93.7637 22.2565C91.3305 22.2565 89.3642 20.2902 89.3642 17.857C89.3642 15.4237 91.3305 13.4575 93.7637 13.4575C95.4105 13.4575 96.836 14.3669 97.5979 15.6941L101.801 13.3592C100.228 10.5572 97.2047 8.64014 93.7637 8.64014C88.676 8.64014 84.5469 12.7693 84.5469 17.857C84.5469 22.9447 88.676 27.0739 93.7637 27.0739C97.2293 27.0739 100.228 25.1813 101.801 22.3548L97.5979 20.0199Z" fill="currentColor"/>
                  <path d="M61.3809 0.996094H56.1211V26.7296H61.3809V0.996094Z" fill="currentColor"/>
                  <path d="M103.836 0.996094V26.7296H109.096V19.012L115.339 26.7296H122.073L114.134 17.5619L121.483 9.00861H115.044L109.096 16.1117V0.996094H103.836Z" fill="currentColor"/>
                  <path d="M77.0482 20.069C76.2862 21.3225 74.7132 22.2565 72.9436 22.2565C70.5103 22.2565 68.5441 20.2902 68.5441 17.857C68.5441 15.4237 70.5103 13.4575 72.9436 13.4575C74.7132 13.4575 76.2862 14.4406 77.0482 15.7187V20.069ZM77.0482 9.00881V11.098C76.1879 9.64785 74.0496 8.64014 71.813 8.64014C67.1923 8.64014 63.5547 12.7201 63.5547 17.8324C63.5547 22.9447 67.1923 27.0739 71.813 27.0739C74.0496 27.0739 76.1879 26.0661 77.0482 24.616V26.7052H82.3079V9.00881H77.0482Z" fill="currentColor"/>
                  <path d="M6.59023 20.0432C6.59023 21.8374 5.14011 23.2875 3.3459 23.2875C1.55168 23.2875 0.101562 21.8374 0.101562 20.0432C0.101562 18.2489 1.55168 16.7988 3.3459 16.7988H6.59023V20.0432Z" fill="currentColor"/>
                  <path d="M8.21484 20.0434C8.21484 18.2492 9.66496 16.7991 11.4592 16.7991C13.2534 16.7991 14.7035 18.2492 14.7035 20.0434V28.1542C14.7035 29.9485 13.2534 31.3986 11.4592 31.3986C9.66496 31.3986 8.21484 29.9485 8.21484 28.1542V20.0434Z" fill="currentColor"/>
                  <path d="M11.4553 7.01674C9.66106 7.01674 8.21094 5.56663 8.21094 3.77241C8.21094 1.9782 9.66106 0.528076 11.4553 0.528076C13.2495 0.528076 14.6996 1.9782 14.6996 3.77241V7.01674H11.4553Z" fill="currentColor"/>
                  <path d="M11.4501 8.66406C13.2443 8.66406 14.6944 10.1142 14.6944 11.9084C14.6944 13.7026 13.2443 15.1527 11.4501 15.1527H3.31465C1.52043 15.1527 0.0703125 13.7026 0.0703125 11.9084C0.0703125 10.1142 1.52043 8.66406 3.31465 8.66406H11.4501Z" fill="currentColor"/>
                  <path d="M24.4609 11.9082C24.4609 10.1139 25.9111 8.66382 27.7053 8.66382C29.4995 8.66382 30.9496 10.1139 30.9496 11.9082C30.9496 13.7024 29.4995 15.1525 27.7053 15.1525H24.4609V11.9082Z" fill="currentColor"/>
                  <path d="M22.8363 11.9078C22.8363 13.702 21.3862 15.1522 19.592 15.1522C17.7978 15.1522 16.3477 13.702 16.3477 11.9078V3.77241C16.3477 1.9782 17.7978 0.528076 19.592 0.528076C21.3862 0.528076 22.8363 1.9782 22.8363 3.77241V11.9078Z" fill="currentColor"/>
                  <path d="M19.592 24.9102C21.3862 24.9102 22.8363 26.3603 22.8363 28.1545C22.8363 29.9487 21.3862 31.3988 19.592 31.3988C17.7978 31.3988 16.3477 29.9487 16.3477 28.1545V24.9102H19.592Z" fill="currentColor"/>
                  <path d="M19.592 23.2877C17.7978 23.2877 16.3477 21.8376 16.3477 20.0434C16.3477 18.2492 17.7978 16.7991 19.592 16.7991H27.7274C29.5216 16.7991 30.9717 18.2492 30.9717 20.0434C30.9717 21.8376 29.5216 23.2877 27.7274 23.2877H19.592Z" fill="currentColor"/>
              </svg>                                                                                    
          </a>
          <a href="#" class="flex justify-center items-center">
              <svg class="h-7 hover:text-gray-900 dark:hover:text-white" viewBox="0 0 83 31" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  <path d="M0.566406 0.625366V8.22062H8.86891V30.2547H17.9914V8.2172H26.2939V0.628783L0.566406 0.625366ZM27.7118 0.625366V30.2547H52.6877V22.6595H36.8412V18.9695H52.6842V11.9106H36.8412V8.22062H52.6842V0.625366H27.7118ZM54.2217 0.625366V30.2547H67.4203C77.7523 30.2547 82.5664 24.4874 82.5664 15.3956C82.5664 7.9302 79.078 0.625366 69.2004 0.625366H54.2217ZM63.3511 8.22062H66.2552C72.8528 8.22062 73.4371 13.4071 73.4371 15.2692C73.4371 18.0538 72.6068 22.6595 66.9215 22.6595H63.3511V8.22062Z" fill="currentColor"/>
              </svg>                                                                                      
          </a>
      </div>
  </div>
...
<section class="bg-white dark:bg-gray-900">
  <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      <div class="text-center text-gray-900">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 lg:text-5xl dark:text-white">Our Values</h2>
      ...
      <div class="grid gap-6 mt-12 lg:mt-14 lg:gap-12 md:grid-cols-3">
          <div class="flex mb-2 md:flex-col md:mb-0">
              ...
              <div>
                  <h3 class="text-xl font-bold md:mt-4 mb-2.5 text-gray-900 dark:text-white">Do the right thing</h3>
                  <p class="text-gray-500 dark:text-gray-400">Providing a safe work environment with appropriate working hours and an honest, living wage are obviously the absolute bare minima ... sadly many fast-fashion factories already stumble at this, seemingly low hurdle.

The factories we partner with, look after their staff and actively support their local communities.</p>
              </div>
          </div>
          <div class="flex mb-2 md:flex-col md:mb-0">
